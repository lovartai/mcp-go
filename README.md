...
[![Build](https://github.com/lovartai/mcp-go/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/lovartai/mcp-go/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/lovartai/mcp-go?cache)](https://goreportcard.com/report/github.com/lovartai/mcp-go)
[![GoDoc](https://pkg.go.dev/badge/github.com/lovartai/mcp-go.svg)](https://pkg.go.dev/github.com/lovartai/mcp-go)
...
import (
    ...
    "github.com/lovartai/mcp-go/server"
)
...
```bash
go get github.com/lovartai/mcp-go
```
